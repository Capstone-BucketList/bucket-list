    ...
    return (
        < >
            <section className="py-8">
                ...
                <h1 className="text-seafoam font-bold text-3xl">Welcome back, [NAME]!</h1>
                <Avatar img="/images/people/profile-picture-5.jpg" rounded bordered className="size-xl">
                    <div className="space-y-1 font-medium">
                        <div>Jesse Leos</div>
                        <div className="text-sm text-gray-500">Member since August 2014</div>
                    </div>
                </Avatar>
                <HR />
                    ...
                    <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                        <div className="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our
                                Team</h2>
                            <p className="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Explore the

export default function SignUp(){
    return (
        <section className="bg-gray-50 dark:bg-gray-900 flex relative">
            <img src ="/adventures6.jpg" alt="adventuer"  className="relative w-full"/>
            <div className="absolute w-full flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
